#include "pharmacyapp.h"
 
PharmacyApp *PharmacyApp::pInstance = NULL;
PharmacyApp::PharmacyApp(QWidget *parent) :QGroupBox(parent)
{
...
PharmacyApp *PharmacyApp::getInstance()
{
    if (pInstance == NULL)
    {
        pInstance = new PharmacyApp();
    }
    return pInstance;
}

PharmacyApp::~PharmacyApp()
{

}

void PharmacyApp::InitData()
{
